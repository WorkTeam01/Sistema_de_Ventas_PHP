/**
 * ============================================================================
 * GESTIÓN DE PROVEEDORES - Inicialización DataTable
 * ============================================================================
 */
    ...
    $('#supplierTable').DataTable({
        ...
        buttons: [{
            ...
            buttons: [{
                ...
                extend: 'pdf',
                title: 'Proveedores - Sistema de Ventas',
                ...
                customize: function (doc) {
                    ...
                    doc.content.splice(0, 1, {
                        text: 'PROVEEDORES - SISTEMA DE VENTAS',
                        style: {
                            fontSize: 16,
                            alignment: 'center',
                            bold: true,
                    ...
                    doc.content.splice(1, 0, {
                        text: 'Listado de proveedores registrados en el sistema',
                        style: {
                            fontSize: 11,
                            alignment: 'center',
                            italic: true,
                ...
                extend: 'excel',
                title: 'Proveedores - Sistema de Ventas',
                messageTop: 'Registro de proveedores del sistema',
