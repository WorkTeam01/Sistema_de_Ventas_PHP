/**
 * ============================================================================
 * GESTIÓN DE PERMISOS - Inicialización DataTable
 * ============================================================================
 */
...
$(document).ready(function () {
    $('#permissionTable').DataTable({
        ...
        buttons: [{
            ...
            buttons: [{
                ...
                extend: 'pdf',
                title: 'Permisos - Sistema de Ventas',
                filename: 'permisos_' + new Date().toISOString().slice(0, 10),
                pageSize: 'LETTER',
                exportOptions: {columns: [0, 1, 2, 3]},
                customize: function (doc) {
                    ...
                    doc.content.splice(0, 1, {
                        text: 'PERMISOS - SISTEMA DE VENTAS',
                        style: {
                            fontSize: 16,
                            alignment: 'center',
                            bold: true,
                    ...
                    doc.content.splice(1, 0, {
                        text: 'Listado de permisos registrados en el sistema',
                        style: {
                            fontSize: 11,
                            alignment: 'center',
                            italic: true,
    ...
    }).buttons().container().appendTo('#permissionTable_wrapper .col-md-6:eq(0)');
});
