/**
 * ============================================================================
 * GESTIÓN DE CATEGORÍAS - Operaciones CRUD con Modales
 * ============================================================================
 * Maneja las operaciones de crear y editar categorías mediante modales y AJAX
...
$(document).ready(function () {
    ...
    $('#formCreate').validate({
        rules: {
            nombre_categoria: {
                ...
                maxlength: 100,
                remote: {
                    url: BASE_URL + '/categories/check-nombre',
                    type: 'POST',
                    data: {
                        nombre_categoria: function () {
                            return $('#create_nombre_categoria').val();
                        },
                        id: function () {
                            return null;
                        }
        ...
        rules: {
            nombre_categoria: {
                ...
                remote: {
                    ...
                    data: {
                        nombre_categoria: function () {
                            return $('#edit_nombre_categoria').val();
                        },
                        id: function () {
    ...
    function crearCategoria() {
        ...
        ToastUtils.loadingWithMinTime('Guardando categoría...', function (loadingToast) {
            $.ajax({
    ...
    $(document).on('click', '.btn-edit', function () {
        ...
        ToastUtils.loadingWithMinTime('Cargando datos de la categoría...', function (loadingToast) {
            $.ajax({
                url: BASE_URL + '/categories/show/' + id,
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    loadingToast.close();
                    ...
                    if (response.success) {
                        ...
                        $('#edit_id').val(data.id_categoria);
                        $('#edit_nombre_categoria').val(data.nombre_categoria);
    ...
    function actualizarCategoria() {
        ...
        ToastUtils.loadingWithMinTime('Actualizando categoría...', function (loadingToast) {
            $.ajax({
                url: BASE_URL + '/categories/update/' + id,
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
