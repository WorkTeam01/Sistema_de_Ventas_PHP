        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h2 class="card-title"><i class="fas fa-receipt mr-1"></i> Venta N° <?= htmlspecialchars($nro_venta, ENT_QUOTES, 'UTF-8') ?></h2>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h2 class="card-title"><i class="fas fa-exclamation-circle mr-1"></i> Confirmar eliminación</h2>
                        </div>
                        <div class="card-body">
