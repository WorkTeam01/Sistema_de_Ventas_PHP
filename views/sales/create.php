                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-shopping-bag"></i> Venta Nro: <?= (int)$nro_venta ?>
                            </h3>
                                                ...
                                                <table id="productTable"
                                                    ...
                                                    foreach ($products as $product) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                Bs. <?= htmlspecialchars($product['precio_venta'], ENT_QUOTES, 'UTF-8') ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                    </tbody>
                                                </table>
                                ...
                                <table class="table table-bordered table-sm table-hover table-striped">
                                    ...
                                    foreach ($cart_items as $item) :
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="<?= BASE_URL ?>/sales/cart/remove" method="post"
