                ...
                <div class="col-md-12">
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-receipt"></i> Venta N° <?= htmlspecialchars($nro_venta, ENT_QUOTES, 'UTF-8') ?></h3>
                            <div class="card-tools">
                                <a href="<?= BASE_URL ?>/sales/invoice/<?= (int) $id_venta ?>" target="_blank" class="btn btn-success btn-sm">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge badge-warning">Bs. <?= htmlspecialchars(number_format((float) $total_pagado, 2), ENT_QUOTES, 'UTF-8') ?></span></td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-sm table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (empty($items)) : ?>
                                            <tr>
                                                <td colspan="6" class="text-center text-muted">No hay productos registrados en esta venta.</td>
                                            </tr>
                                        <?php else : ?>
                                            <tr class="bg-light">
                                                ...
                                                <th></th>
                                                <th class="text-center text-warning">Bs. <?= number_format($precio_total, 2) ?></th>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
