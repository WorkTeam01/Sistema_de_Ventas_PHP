...
<head>
    ...
    <?php if (in_array('datatable', $assets ?? [])) : ?>
        <!-- DataTables -->
        <link rel="stylesheet"
            href="<?= BASE_URL ?>/templates/AdminLTE-3.2.0/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
        <link rel="stylesheet"
            href="<?= BASE_URL ?>/templates/AdminLTE-3.2.0/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
        <link rel="stylesheet"
            href="<?= BASE_URL ?>/templates/AdminLTE-3.2.0/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <?php endif; ?>
    <?php if (in_array('select2', $assets ?? [])) : ?>
        ...
        <link rel="stylesheet"
            href="<?= BASE_URL ?>/templates/AdminLTE-3.2.0/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    <?php endif; ?>
