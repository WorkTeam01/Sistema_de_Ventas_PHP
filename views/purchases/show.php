        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card card-info">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-1"><strong><?= htmlspecialchars($codigo, ENT_QUOTES, 'UTF-8'); ?></strong></p>
                        ...
                        <div class="card-footer">
                            <a href="<?= BASE_URL ?>/purchases/edit/<?= $id_compra ?>" class="btn btn-success btn-block">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-shopping-cart mr-1"></i> Compra N° <?= htmlspecialchars($nro_compra, ENT_QUOTES, 'UTF-8'); ?></h3>
                        </div>
